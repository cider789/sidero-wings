...
func (s *sideroExtension) health(c *gin.Context) {
	...
	components := gin.H{
		...
		"file_search":           featureHealth(features["file_search"], operationAvailable),
		"content_search":        featureHealth(features["content_search"], operationAvailable),
		"remote_download":       featureHealth(features["remote_download"], operationAvailable),
